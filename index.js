...
const Flora = [
  {id: 1, imagem: 'https://p2.trrsf.com/image/fget/cf/940/0/images.terra.com/2022/07/01/1451421885-15-tipos-de-lavanda-para-perfumar-seu-jardim-gardeningetc-kernock-park-plants.jpg', nome:'Lavanda', origem:'A lavanda é nativa das regiões montanhosas da Europa ao redor do Mediterrâneo, incluindo países como França, Espanha, Itália e Croácia. É conhecida por suas flores roxas e aroma relaxante', categoria: 'Planta', solo: 'A lavanda prefere solos bem drenados, arenosos ou calcários. Evite solos muito úmidos, pois a planta é suscetível ao apodrecimento das raízes.',
    localizacao: "Plante a lavanda em um local que receba pelo menos 6 horas de sol direto por dia.", irrigacao: ' Regue moderadamente, permitindo que o solo seque entre as regas. A lavanda é resistente à seca uma vez estabelecida.', adubacao: 'Utilize um fertilizante balanceado, preferencialmente orgânico, que seja de liberação lenta. O adubo deve ser baixo em nitrogênio e mais rico em fósforo e potássio, pois isso favorece a floração.', podas: ' Realize podas regulares após a floração para manter a planta compacta e incentivar novas flores.',
    curiosidade:'Além de ser amplamente utilizada em jardins ornamentais, a lavanda tem várias aplicações medicinais e cosméticas, como em chás, infusões, óleos e sachês aromáticos.'
  },

  {id: 2, imagem: 'https://img.freepik.com/fotos-premium/rosas-de-jardim-roseira-flores-cor-de-rosa-no-jardim_156843-552.jpg', nome:'Rosa ', origem:'As rosas têm uma origem diversificada, mas a maioria das espécies é nativa da Ásia. Algumas espécies também são encontradas na Europa, América do Norte e África. São amplamente cultivadas por suas flores belas e perfumadas', categoria: 'Planta', solo: 'As rosas preferem solos bem drenados e ricos em matéria orgânica. Adicione compostagem ou esterco bem decomposto ao solo para melhorar a fertilidade.',
    localizacao: 'Plante as rosas em um local que receba pelo menos 6 horas de sol direto por dia. Elas se desenvolvem melhor em áreas com boa circulação de ar.', irrigacao: ' Regue as rosas regularmente, mantendo o solo úmido mas não encharcado. Evite molhar as folhas para prevenir doenças fúngicas.', adubacao: 'Fertilize regularmente durante a estação de crescimento, utilizando um fertilizante específico para rosas ou um fertilizante balanceado.', curiosidade: 'Além de sua beleza ornamental, as pétalas de algumas espécies de rosas são utilizadas em cosméticos, perfumes e produtos medicinais, como águas florais e óleos essenciais.'
  },

  {id: 3, imagem: 'https://casa.abril.com.br/wp-content/uploads/2021/09/Como-plantar-e-cuidar-de-horte%CC%82nsias-10.jpg?crop=1&resize=1212,909', nome:'Hortênsia', origem:'As hortênsias são nativas do sul e leste da Ásia, particularmente Japão, China e Himalaia. Elas são populares por suas grandes inflorescências que podem ser de várias cores, incluindo azul, rosa, branco e roxo', categoria: 'Planta', solo: 'Preferem solos ricos em matéria orgânica, bem drenados e levemente ácidos. A acidez do solo pode influenciar a cor das flores.',
    localizacao: 'Idealmente, devem ser plantadas em áreas que recebam sol da manhã e sombra à tarde. Em climas mais frios, elas podem tolerar mais sol.', irrigacao: 'Mantenha o solo úmido, mas não encharcado. Hortênsias precisam de rega regular, especialmente durante períodos secos.', adubacao: 'Use um fertilizante balanceado (10-10-10) ou um específico para hortênsias. Para alterar a cor das flores, adubos contendo alumínio (para flores azuis) ou calcário (para flores rosas) podem ser usados.', curiosidade:'As flores da hortênsia podem ser de várias cores, incluindo azul, rosa, branco e roxo, dependendo da variedade e do pH do solo. As inflorescências podem ser esféricas ou em formato de cone.'
  },

  {id: 4, imagem: 'https://imagens-revista.vivadecora.com.br/uploads/2019/11/crisantemo.jpg', nome:'Crisântemo', origem:'Originário da China, o crisântemo tem sido cultivado há mais de 2.500 anos. Também é popular no Japão, onde simboliza o sol e é uma flor nacional. As flores vêm em uma variedade de cores e formas', categoria: 'Planta', solo:' Prefere solos bem drenados, ricos em matéria orgânica. A adição de compostagem pode melhorar a qualidade do solo.', localizacao: 'Plante em um local que receba pelo menos 6 horas de sol direto por dia para estimular a floração.',
    irrigacao:'Regue regularmente para manter o solo uniformemente úmido, mas não encharcado. Evite molhar as folhas para prevenir doenças fúngicas.', adubacao:"Utilize um fertilizante balanceado (20-10-20) ou um específico para flores. Fertilizantes com maior teor de fósforo são recomendados para incentivar a floração.", curiosidade:'No Japão, o crisântemo é um símbolo do sol e é associado à longevidade e rejuvenescimento. Na China, eles são símbolos de vida e morte, frequentemente usados em cerimônias e festividades.'
  },

  {id: 5, imagem: 'https://blog.cobasi.com.br/wp-content/uploads/2023/02/jasmim-capa.png', nome:'Jasmim', origem:'O jasmim é nativo das regiões tropicais e subtropicais da Eurásia, Australásia e Oceania. É altamente valorizado pelo seu perfume doce e é usado em perfumes e chás', categoria: 'Planta', solo:' Prefere solos bem drenados e ricos em matéria orgânica. Adicione compostagem ou esterco bem decomposto para melhorar a fertilidade do solo.', localizacao:' Plante o jasmim em um local que receba pleno sol ou sombra parcial. Ele precisa de pelo menos 4 a 6 horas de sol direto por dia para florescer bem.', irrigacao:' Mantenha o solo consistentemente úmido, mas evite encharcá-lo. Regue regularmente, especialmente durante períodos secos.',
    adubacao:'Utilize um fertilizante balanceado (10-10-10) ou um específico para plantas floríferas. Fertilizantes ricos em fósforo são ideais para estimular a floração regurlamente durante sua estação de crescimento.', curiosidade:" Em muitas culturas, o jasmim é associado à pureza, beleza e amor. Ele é frequentemente usado em cerimônias e como ornamento em eventos festivos."
  },
